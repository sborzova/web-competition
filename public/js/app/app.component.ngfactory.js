...
var _View_AppComponent0 = (function (_super) {
    ...
    _View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_4 = this.renderer.createElement(this._el_0, 'router-outlet', null);
        this._appEl_4 = new import2.AppElement(4, 0, this, this._el_4);
        this._RouterOutlet_4_5 = new import11.RouterOutlet(this.parentInjector.get(import15.RouterOutletMap), this._appEl_4.vcRef, this.parentInjector.get(import16.ComponentFactoryResolver), null);
    ...
    _View_AppComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import11.RouterOutlet) && (4 === requestNodeIndex))) {
            return this._RouterOutlet_4_5;
        }
        return notFoundResult;
    };
