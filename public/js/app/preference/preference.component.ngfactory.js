...
function viewFactory_PreferenceComponent_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_PreferenceComponent_Host === null)) {
        (renderType_PreferenceComponent_Host = viewUtils.createRenderComponentType('', 0, import11.ViewEncapsulation.None, [], {}));
    }
    return new _View_PreferenceComponent_Host0(viewUtils, parentInjector, declarationEl);
}
export var PreferenceComponentNgFactory = new import12.ComponentFactory('app-preference', viewFactory_PreferenceComponent_Host0, import3.PreferenceComponent);
...
var _View_PreferenceComponent0 = (function (_super) {
    ...
    _View_PreferenceComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_0 = this.context.value;
        if (import4.checkBinding(throwOnChange, this._expr_0, currVal_0)) {
            this._NgIf_12_6.ngIf = currVal_0;
            this._expr_0 = currVal_0;
        }
        var currVal_1 = !this.context.value;
...
export function viewFactory_PreferenceComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_PreferenceComponent === null)) {
        (renderType_PreferenceComponent = viewUtils.createRenderComponentType('C:/Users/Silvia/OneDrive/Bakalárka/Project/assets/app/preference/preference.component.html', 0, import11.ViewEncapsulation.None, styles_PreferenceComponent, {}));
    }
