...
var _View_InstanceEditComponent_Host0 = (function (_super) {
    ...
    _View_InstanceEditComponent_Host0.prototype.destroyInternal = function () {
...
function viewFactory_InstanceEditComponent_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_InstanceEditComponent_Host === null)) {
        (renderType_InstanceEditComponent_Host = viewUtils.createRenderComponentType('', 0, import12.ViewEncapsulation.None, [], {}));
    }
    return new _View_InstanceEditComponent_Host0(viewUtils, parentInjector, declarationEl);
}
export var InstanceEditComponentNgFactory = new import13.ComponentFactory('app-instance-edit', viewFactory_InstanceEditComponent_Host0, import3.InstanceEditComponent);
...
var _View_InstanceEditComponent0 = (function (_super) {
    ...
    _View_InstanceEditComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._viewQuery_stats_0 = new import14.QueryList();
        ...
        this._text_9 = this.renderer.createText(this._el_8, 'Modify instance', null);
        ...
        this._TemplateRef_12_5 = new import16.TemplateRef_(this._appEl_12, viewFactory_InstanceEditComponent1);
    ...
    _View_InstanceEditComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        if (!throwOnChange) {
            if (this._viewQuery_stats_0.dirty) {
                this._viewQuery_stats_0.reset([this._appEl_12.mapNestedViews(_View_InstanceEditComponent1, function (nestedView) {
            ...
            if (this._viewQuery_data_1.dirty) {
                this._viewQuery_data_1.reset([this._appEl_12.mapNestedViews(_View_InstanceEditComponent1, function (nestedView) {
...
export function viewFactory_InstanceEditComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_InstanceEditComponent === null)) {
        (renderType_InstanceEditComponent = viewUtils.createRenderComponentType('C:/Users/Silvia/OneDrive/Bakalárka/Project/assets/app/instances/instance-update/instance-update.component.html', 0, import12.ViewEncapsulation.None, styles_InstanceEditComponent, {}));
    }
...
var _View_InstanceEditComponent1 = (function (_super) {
    ...
    _View_InstanceEditComponent1.prototype.createInternal = function (rootSelector) {
        ...
        this._FormControlDirective_7_6 = new import23.FormControlDirective(null, null, this._NG_VALUE_ACCESSOR_7_5);
        ...
        this._FormControlDirective_27_5 = new import23.FormControlDirective(null, null, this._NG_VALUE_ACCESSOR_27_4);
    ...
    _View_InstanceEditComponent1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import22.NumberValueAccessor) && (7 === requestNodeIndex))) {
        ...
        if (((token === import21.DefaultValueAccessor) && (27 === requestNodeIndex))) {
            return this._DefaultValueAccessor_27_3;
        }
        if (((token === import26.NG_VALUE_ACCESSOR) && (27 === requestNodeIndex))) {
            return this._NG_VALUE_ACCESSOR_27_4;
        }
        if (((token === import23.FormControlDirective) && (27 === requestNodeIndex))) {
            return this._FormControlDirective_27_5;
        }
        if (((token === import27.NgControl) && (27 === requestNodeIndex))) {
    ...
    _View_InstanceEditComponent1.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_11 = this._map_0((!this.parent.context.myForm.controls['order'].valid && (this.parent.context.myForm.controls['order'].touched || this.parent.context.isSubmitted())));
        ...
        changes = null;
        var currVal_17 = this.parent.context.myForm.controls['order'];
        ...
        var currVal_24 = (!this.parent.context.myForm.controls['order'].valid && (this.parent.context.myForm.controls['order'].touched || this.parent.context.isSubmitted()));
        ...
        var currVal_26 = this._map_1((!this.parent.context.myForm.controls['name'].valid && (this.parent.context.myForm.controls['name'].touched || this.parent.context.isSubmitted())));
        ...
        changes = null;
        var currVal_29 = this.parent.context.myForm.controls['name'];
        ...
        var currVal_36 = (this.parent.context.myForm.controls['name'].hasError('required') && (this.parent.context.myForm.controls['name'].touched || this.parent.context.isSubmitted()));
        ...
        var currVal_38 = this._map_2((!this.parent.context.myForm.controls['description'].valid && (this.parent.context.myForm.controls['description'].touched || this.parent.context.isSubmitted())));
        ...
        changes = null;
        var currVal_41 = this.parent.context.myForm.controls['description'];
        ...
        var currVal_48 = (this.parent.context.myForm.controls['description'].hasError('required') && (this.parent.context.myForm.controls['description'].touched || this.parent.context.isSubmitted()));
    ...
    _View_InstanceEditComponent1.prototype.dirtyParentQueriesInternal = function () {
        this.parent._viewQuery_stats_0.setDirty();
