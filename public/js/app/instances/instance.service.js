...
export var InstanceService = (function () {
    ...
    InstanceService.prototype.saveInstance = function (instance) {
        ...
        return this.http.post(this.hostUrl.concat('instance'), body, { headers: headers })
            ...
            var instance = new Instance(result.order, result.name, result.description, null, null, result.postDate, result._id);
            _this.instances.push(instance);
            return instance;
        })
            .catch(function (error) {
            if (error.status === 422) {
                _this.flashMessageService.showMessage('The name is already in use.', 'alert-danger');
            }
    ...
    InstanceService.prototype.getInstance = function (id) {
        return this.http.get(this.hostUrl.concat('instance/' + id))
            ...
            return new Instance(instance.order, instance.name, instance.description, instance.stats, instance.data, instance.postDate, instance._id);
        })
            .catch(function (error) {
            return Observable.throw(error);
        });
    ...
    InstanceService.prototype.getInstances = function () {
        ...
        return this.http.get(this.hostUrl.concat('instances'))
            ...
            for (var _i = 0, instances_1 = instances; _i < instances_1.length; _i++) {
                ...
                transformedInstances.push(new Instance(instance.order, instance.name, instance.description, null, null, instance.postDate, instance._id));
            }
