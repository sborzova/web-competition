...
var ResultsModuleInjector = (function (_super) {
    ...
    function ResultsModuleInjector(parent) {
        _super.call(this, parent, [import10.ResultsComponentNgFactory], []);
    }
    ...
    Object.defineProperty(ResultsModuleInjector.prototype, "_InstanceService_7", {
        get: function () {
            if ((this.__InstanceService_7 == null)) {
                (this.__InstanceService_7 = new import7.InstanceService(this.parent.get(import13.Http), this.parent.get(import14.FlashMessageService)));
            }
    ...
    Object.defineProperty(ResultsModuleInjector.prototype, "_SolutionService_8", {
        get: function () {
            if ((this.__SolutionService_8 == null)) {
                (this.__SolutionService_8 = new import8.SolutionService(this.parent.get(import13.Http), this.parent.get(import14.FlashMessageService)));
            }
