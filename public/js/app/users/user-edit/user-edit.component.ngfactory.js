...
var _View_UserEditComponent1 = (function (_super) {
    ...
    _View_UserEditComponent1.prototype.createInternal = function (rootSelector) {
        ...
        this._TemplateRef_44_5 = new import15.TemplateRef_(this._appEl_44, viewFactory_UserEditComponent8);
        ...
        this._el_51 = this.renderer.createElement(this._el_46, 'button', null);
        ...
        var disposable_9 = this.renderer.listen(this._el_51, 'click', this.eventHandler(this._handle_click_51_0.bind(this)));
    ...
    _View_UserEditComponent1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import15.TemplateRef) && (44 === requestNodeIndex))) {
            return this._TemplateRef_44_5;
        }
        if (((token === import14.NgIf) && (44 === requestNodeIndex))) {
            return this._NgIf_44_6;
        }
        if (((token === import16.FormGroupDirective) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 54)))) {
            return this._FormGroupDirective_0_3;
        }
        if (((token === import27.ControlContainer) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 54)))) {
            return this._ControlContainer_0_4;
        }
        if (((token === import17.NgControlStatusGroup) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 54)))) {
    ...
    _View_UserEditComponent1.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_49 = this.parent.context.passwordForm;
        if (import4.checkBinding(throwOnChange, this._expr_49, currVal_49)) {
            this._NgIf_44_6.ngIf = currVal_49;
    ...
    _View_UserEditComponent1.prototype._handle_click_51_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
...
var _View_UserEditComponent8 = (function (_super) {
    __extends(_View_UserEditComponent8, _super);
    function _View_UserEditComponent8(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_UserEditComponent8, renderType_UserEditComponent, import6.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_UserEditComponent8.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.renderer.createElement(null, 'form', null);
        this._FormGroupDirective_0_3 = new import16.FormGroupDirective(null, null);
        this._ControlContainer_0_4 = this._FormGroupDirective_0_3;
        this._NgControlStatusGroup_0_5 = new import17.NgControlStatusGroup(this._ControlContainer_0_4);
        ...
        this._el_2 = this.renderer.createElement(this._el_0, 'div', null);
        this.renderer.setElementAttribute(this._el_2, 'class', 'form-group');
        this._NgClass_2_3 = new import18.NgClass(this.parent.parent.parentInjector.get(import22.IterableDiffers), this.parent.parent.parentInjector.get(import23.KeyValueDiffers), new import24.ElementRef(this._el_2), this.renderer);
        this._text_3 = this.renderer.createText(this._el_2, '\n                            ', null);
        this._el_4 = this.renderer.createElement(this._el_2, 'label', null);
        ...
        this._anchor_9 = this.renderer.createTemplateAnchor(this._el_2, null);
        this._appEl_9 = new import2.AppElement(9, 2, this, this._anchor_9);
        this._TemplateRef_9_5 = new import15.TemplateRef_(this._appEl_9, viewFactory_UserEditComponent9);
        this._NgIf_9_6 = new import14.NgIf(this._appEl_9.vcRef, this._TemplateRef_9_5);
        this._text_10 = this.renderer.createText(this._el_2, '\n                        ', null);
        ...
        this._expr_10 = import7.UNINITIALIZED;
        var disposable_2 = this.renderer.listen(this._el_7, 'input', this.eventHandler(this._handle_input_7_0.bind(this)));
        var disposable_3 = this.renderer.listen(this._el_7, 'blur', this.eventHandler(this._handle_blur_7_1.bind(this)));
    ...
    _View_UserEditComponent8.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import19.DefaultValueAccessor) && (7 === requestNodeIndex))) {
            return this._DefaultValueAccessor_7_3;
        }
        if (((token === import25.NG_VALUE_ACCESSOR) && (7 === requestNodeIndex))) {
        ...
        if (((token === import16.FormGroupDirective) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 11)))) {
            return this._FormGroupDirective_0_3;
        }
        if (((token === import27.ControlContainer) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 11)))) {
            return this._ControlContainer_0_4;
        }
        if (((token === import17.NgControlStatusGroup) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 11)))) {
            return this._NgControlStatusGroup_0_5;
        }
        return notFoundResult;
    };
    _View_UserEditComponent8.prototype.detectChangesInternal = function (throwOnChange) {
        var changes = null;
        changes = null;
        var currVal_2 = this.parent.parent.context.passwordForm;
        if (import4.checkBinding(throwOnChange, this._expr_2, currVal_2)) {
        ...
        if (import4.checkBinding(throwOnChange, this._expr_9, currVal_9)) {
            this._NgClass_2_3.klass = currVal_9;
            this._expr_9 = currVal_9;
        }
        var currVal_10 = this._map_0((!this.parent.parent.context.passwordForm.controls['password'].valid && (this.parent.parent.context.passwordForm.controls['password'].touched || this.parent.parent.context.submitted)));
        if (import4.checkBinding(throwOnChange, this._expr_10, currVal_10)) {
            this._NgClass_2_3.ngClass = currVal_10;
            this._expr_10 = currVal_10;
        }
        if (!throwOnChange) {
            this._NgClass_2_3.ngDoCheck();
        ...
        changes = null;
        var currVal_13 = this.parent.parent.context.passwordForm.controls['password'];
        if (import4.checkBinding(throwOnChange, this._expr_13, currVal_13)) {
            this._FormControlDirective_7_5.form = currVal_13;
            if ((changes === null)) {
                (changes = {});
            }
            changes['form'] = new import7.SimpleChange(this._expr_13, currVal_13);
            this._expr_13 = currVal_13;
        }
        if ((changes !== null)) {
            this._FormControlDirective_7_5.ngOnChanges(changes);
        }
        var currVal_20 = (this.parent.parent.context.passwordForm.controls['password'].hasError('required') && (this.parent.parent.context.passwordForm.controls['password'].touched || this.parent.parent.context.submitted));
        if (import4.checkBinding(throwOnChange, this._expr_20, currVal_20)) {
            this._NgIf_9_6.ngIf = currVal_20;
            this._expr_20 = currVal_20;
        }
        this.detectContentChildrenChanges(throwOnChange);
        ...
        var currVal_14 = this._NgControlStatus_7_7.ngClassUntouched;
        if (import4.checkBinding(throwOnChange, this._expr_14, currVal_14)) {
            this.renderer.setElementClass(this._el_7, 'ng-untouched', currVal_14);
            this._expr_14 = currVal_14;
        }
        var currVal_15 = this._NgControlStatus_7_7.ngClassTouched;
        if (import4.checkBinding(throwOnChange, this._expr_15, currVal_15)) {
            this.renderer.setElementClass(this._el_7, 'ng-touched', currVal_15);
            this._expr_15 = currVal_15;
        }
        var currVal_16 = this._NgControlStatus_7_7.ngClassPristine;
        if (import4.checkBinding(throwOnChange, this._expr_16, currVal_16)) {
            this.renderer.setElementClass(this._el_7, 'ng-pristine', currVal_16);
            this._expr_16 = currVal_16;
        }
        var currVal_17 = this._NgControlStatus_7_7.ngClassDirty;
        if (import4.checkBinding(throwOnChange, this._expr_17, currVal_17)) {
            this.renderer.setElementClass(this._el_7, 'ng-dirty', currVal_17);
            this._expr_17 = currVal_17;
        }
        var currVal_18 = this._NgControlStatus_7_7.ngClassValid;
        if (import4.checkBinding(throwOnChange, this._expr_18, currVal_18)) {
            this.renderer.setElementClass(this._el_7, 'ng-valid', currVal_18);
            this._expr_18 = currVal_18;
        }
        var currVal_19 = this._NgControlStatus_7_7.ngClassInvalid;
        if (import4.checkBinding(throwOnChange, this._expr_19, currVal_19)) {
    ...
    _View_UserEditComponent8.prototype._handle_submit_0_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._FormGroupDirective_0_3.onSubmit() !== false);
        return (true && pd_0);
    };
    _View_UserEditComponent8.prototype._handle_reset_0_1 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._FormGroupDirective_0_3.onReset() !== false);
        return (true && pd_0);
    };
    _View_UserEditComponent8.prototype._handle_input_7_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_7_3.onChange($event.target.value) !== false);
        return (true && pd_0);
    };
    _View_UserEditComponent8.prototype._handle_blur_7_1 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_7_3.onTouched() !== false);
        return (true && pd_0);
    };
    return _View_UserEditComponent8;
}(import1.AppView));
function viewFactory_UserEditComponent8(viewUtils, parentInjector, declarationEl) {
    return new _View_UserEditComponent8(viewUtils, parentInjector, declarationEl);
}
var _View_UserEditComponent9 = (function (_super) {
    __extends(_View_UserEditComponent9, _super);
    function _View_UserEditComponent9(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_UserEditComponent9, renderType_UserEditComponent, import6.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_UserEditComponent9.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.renderer.createElement(null, 'div', null);
        this.renderer.setElementAttribute(this._el_0, 'class', 'field-error');
        this._text_1 = this.renderer.createText(this._el_0, '\n                                Field is required.\n                            ', null);
        this.init([].concat([this._el_0]), [
    ...
    return _View_UserEditComponent9;
}(import1.AppView));
function viewFactory_UserEditComponent9(viewUtils, parentInjector, declarationEl) {
    return new _View_UserEditComponent9(viewUtils, parentInjector, declarationEl);
}
