...
var _View_SigninComponent0 = (function (_super) {
    ...
    _View_SigninComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_21 = this.renderer.createText(this._el_20, 'Sign in', null);
        this._text_22 = this.renderer.createText(this._el_2, '\n    ', null);
        this._text_23 = this.renderer.createText(this._el_0, '\n    ', null);
        this._el_24 = this.renderer.createElement(this._el_0, 'a', null);
        this._text_25 = this.renderer.createText(this._el_24, 'Forgot your password?', null);
...
export function viewFactory_SigninComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SigninComponent === null)) {
        (renderType_SigninComponent = viewUtils.createRenderComponentType('C:/Users/Silvia/OneDrive/Bakalárka/Project/assets/app/auth/signin.component.html', 0, import10.ViewEncapsulation.None, styles_SigninComponent, {}));
    }
