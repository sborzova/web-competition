...
export var SignupComponentNgFactory = new import11.ComponentFactory('app-signup', viewFactory_SignupComponent_Host0, import3.SignupComponent);
...
var _View_SignupComponent0 = (function (_super) {
    ...
    _View_SignupComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._FormControlName_25_5 = new import15.FormControlName(this._ControlContainer_2_4, null, null, this._NG_VALUE_ACCESSOR_25_4);
        ...
        this._FormControlName_33_5 = new import15.FormControlName(this._ControlContainer_2_4, null, null, this._NG_VALUE_ACCESSOR_33_4);
    ...
    _View_SignupComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import14.DefaultValueAccessor) && (25 === requestNodeIndex))) {
        ...
        if (((token === import15.FormControlName) && (25 === requestNodeIndex))) {
        ...
        if (((token === import14.DefaultValueAccessor) && (33 === requestNodeIndex))) {
            return this._DefaultValueAccessor_33_3;
        }
        if (((token === import17.NG_VALUE_ACCESSOR) && (33 === requestNodeIndex))) {
            return this._NG_VALUE_ACCESSOR_33_4;
        }
        if (((token === import15.FormControlName) && (33 === requestNodeIndex))) {
        ...
        if (((token === import12.FormGroupDirective) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 38)))) {
            return this._FormGroupDirective_2_3;
        }
        if (((token === import19.ControlContainer) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 38)))) {
            return this._ControlContainer_2_4;
        }
        if (((token === import13.NgControlStatusGroup) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 38)))) {
...
export function viewFactory_SignupComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SignupComponent === null)) {
        (renderType_SignupComponent = viewUtils.createRenderComponentType('C:/Users/Silvia/OneDrive/Bakalárka/Project/assets/app/auth/signup.component.html', 0, import10.ViewEncapsulation.None, styles_SignupComponent, {}));
    }
