...
class _View_ProfileEditPasswordComponent_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._ProfileEditPasswordComponent_0_4 = new import3.ProfileEditPasswordComponent(this.parentInjector.get(import8.AuthService),this.parentInjector.get(import9.FlashMessageService),this.parentInjector.get(import10.Router));
