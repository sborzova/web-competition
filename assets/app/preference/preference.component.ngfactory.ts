...
class _View_PreferenceComponent_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._PreferenceComponent_0_4 = new import3.PreferenceComponent(this.parentInjector.get(import8.PreferenceService),this.parentInjector.get(import9.FlashMessageService),this.parentInjector.get(import10.SessionStorageService));
...
function viewFactory_PreferenceComponent_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_PreferenceComponent_Host === (null as any))) { (renderType_PreferenceComponent_Host = viewUtils.createRenderComponentType('',0,import11.ViewEncapsulation.None,[],{})); }
  return new _View_PreferenceComponent_Host0(viewUtils,parentInjector,declarationEl);
}
export const PreferenceComponentNgFactory:import12.ComponentFactory<import3.PreferenceComponent> = new import12.ComponentFactory<import3.PreferenceComponent>('app-preference',viewFactory_PreferenceComponent_Host0,import3.PreferenceComponent);
...
class _View_PreferenceComponent0 extends import1.AppView<import3.PreferenceComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_10,'class','col-xs-9 col-sm-2');
    ...
    this.renderer.setElementAttribute(this._el_17,'class','col-xs-3 col-sm-10');
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_1:boolean = !this.context.value;
...
export function viewFactory_PreferenceComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.PreferenceComponent> {
  if ((renderType_PreferenceComponent === (null as any))) { (renderType_PreferenceComponent = viewUtils.createRenderComponentType('C:/Users/Silvia/OneDrive/Bakalárka/Project/assets/app/preference/preference.component.html',0,import11.ViewEncapsulation.None,styles_PreferenceComponent,{})); }
