...
class _View_PreferenceComponent0 extends import1.AppView<import3.PreferenceComponent> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_0:any = this.context.isCompetitionOn();
    if (import4.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
      this._NgIf_12_6.ngIf = currVal_0;
      this._expr_0 = currVal_0;
    }
    const currVal_1:boolean = !this.context.isCompetitionOn();
    if (import4.checkBinding(throwOnChange,this._expr_1,currVal_1)) {
      this._NgIf_14_6.ngIf = currVal_1;
      this._expr_1 = currVal_1;
    }
    const currVal_2:any = this.context.isCompetitionOn();
    if (import4.checkBinding(throwOnChange,this._expr_2,currVal_2)) {
      this._NgIf_19_6.ngIf = currVal_2;
      this._expr_2 = currVal_2;
    }
    const currVal_3:boolean = !this.context.isCompetitionOn();
