...
export function viewFactory_PreferenceComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.PreferenceComponent> {
  if ((renderType_PreferenceComponent === (null as any))) { (renderType_PreferenceComponent = viewUtils.createRenderComponentType('C:/Users/Silvia/OneDrive/Bc/web-competition/assets/app/preference/preference.component.html',0,import10.ViewEncapsulation.None,styles_PreferenceComponent,{})); }
