...
class _View_InstanceEditComponent0 extends import1.AppView<import3.InstanceEditComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._text_9 = this.renderer.createText(this._el_8,'Modify instance',(null as any));
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    if (!throwOnChange) {
      if (this._viewQuery_stats_0.dirty) {
          this._viewQuery_stats_0.reset([this._appEl_12.mapNestedViews(_View_InstanceEditComponent1,(nestedView:_View_InstanceEditComponent1):any => {
      ...
      if (this._viewQuery_data_1.dirty) {
          this._viewQuery_data_1.reset([this._appEl_12.mapNestedViews(_View_InstanceEditComponent1,(nestedView:_View_InstanceEditComponent1):any => {
...
class _View_InstanceEditComponent1 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._el_58 = this.renderer.createElement(this._el_53,'a',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import18.FormGroupDirective) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 62)))) { return this._FormGroupDirective_0_3; }
    if (((token === import28.ControlContainer) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 62)))) { return this._ControlContainer_0_4; }
    if (((token === import19.NgControlStatusGroup) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 62)))) { return this._NgControlStatusGroup_0_5; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
