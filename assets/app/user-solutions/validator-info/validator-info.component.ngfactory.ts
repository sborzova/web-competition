...
export function viewFactory_ValidatorInfoComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ValidatorInfoComponent> {
  if ((renderType_ValidatorInfoComponent === (null as any))) { (renderType_ValidatorInfoComponent = viewUtils.createRenderComponentType('C:/Users/Silvia/OneDrive/Bakalárka/Project/assets/app/user-solutions/validator-info/validator-info.component.html',0,import10.ViewEncapsulation.None,styles_ValidatorInfoComponent,{})); }
