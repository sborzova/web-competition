...
import * as import16 from './messages/errors/error.component.ngfactory';
import * as import17 from './messages/errors/error.service';
...
class _View_AppComponent0 extends import1.AppView<import3.AppComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this._HeaderComponent_2_4 = new import10.HeaderComponent(this.parentInjector.get(import14.AuthService),this.parentInjector.get(import15.Router));
    ...
    var compView_4:any = import16.viewFactory_ErrorComponent0(this.viewUtils,this.injector(4),this._appEl_4);
    this._ErrorComponent_4_4 = new import11.ErrorComponent(this.parentInjector.get(import17.ErrorService));
